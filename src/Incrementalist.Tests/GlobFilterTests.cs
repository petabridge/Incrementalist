...
public class GlobFilterTests
{
    public class AbsolutePaths
    {
        ...
        {
            public static readonly IReadOnlyList<string> LinuxTestProjects = new List<string>
            {
            ...
            public void FilterProjects_OnlyTargetFilters_ReturnsMatchingProjects(string[] targetGlobs, int expectedCount)
            {
                ...
                // Act
                var result = GlobFilter.FilterProjects(LinuxTestProjects, skipGlobs, targetGlobs);
        ...
        {
            public static readonly IReadOnlyList<string> WindowsTestProjects = new List<string>
            {
            ...
            public void FilterProjects_OnlyTargetFilters_ReturnsMatchingProjects(string[] targetGlobs, int expectedCount)
            {
                ...
                // Act
                var result = GlobFilter.FilterProjects(WindowsTestProjects, skipGlobs, targetGlobs);
